<%@ Page Language="C#" MasterPageFile="~/Classifieds/MPClassifieds1.master" AutoEventWireup="true" CodeFile="UserProfile_Step02.aspx.cs" Inherits="Classifieds_UserProfile_Step02" Title="www.apnerdeal.com – New User Registration." %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table width="1000" border="0px" align="center" cellpadding="0" cellspacing="0">
    <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <td align="right" valign="bottom" style="height: 22px"><div  class="step">Step 2 of 3</div></td>
         </tr>
    </table>
    <br /><br />
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cptable" style="border-top:1px solid #EFEFE2;">
        ...
        <tr>
            ...
            <li style="padding-bottom:7px;">
            In the email message from us, click the provided link/url to confirm your registration.
            </li>
            ...
            <li>
             If you do not find the Registration Confirmation mail in your E-mail Box, Please do contact us: +8801678115452
            </li>
