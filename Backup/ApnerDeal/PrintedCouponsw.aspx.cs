...
public partial class PrintedCouponsw : System.Web.UI.Page
{
    ...
    private void Load_CouponPrintingInformation(int profileID, int CouponID)
    {
        try
        {
            ...
            dt = manager.Load_WonCouponPrintingInformation(objDiscountZone);
            if (dt.Rows.Count > 0)
            {
    ...
    protected void fvPrientCoupon_ItemCreated(object sender, EventArgs e)
    {
    }
}
