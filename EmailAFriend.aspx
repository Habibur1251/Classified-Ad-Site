<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/New.master" CodeFile="EmailAFriend.aspx.cs" Inherits="EmailAFriend" %>
<asp:Content ContentPlaceHolderID="content" runat="server">
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>ApnerDeal.con Email a friend</title>
...
<body>
    ...
    <table width="1100px" border="0" style="margin-top: 20px" align="center" cellpadding="0"cellspacing="0">
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <p style="word-break: normal; word-wrap: normal; padding: 5px" class="gray11px">
                        ...
                        a discount to your friend using this service. Your Friend will be notified about the
                        discount through e-mail. To use this service you are required to provide the
                        following information:
                    </p>
                </td>
            </tr>
        </table>
        <table width="1115px" border="0" style="margin-top: 20px" align="center" cellpadding="0"
            cellspacing="0">
            <tr>
                <td width="3px">
                ...
                <td width="300px" style="font-size: 14px; font-weight: bold; background-image: url(images/title_bar_bg.gif);
                    ...
                    Email this Discount offer to a friend.
                </td>
                <td width="3px">
                    <img src="images/title_bar_right.gif" alt="" width="3" height="28" /></td>
            </tr>
        </table>
        <table class="cptable" width="1100px" border="0" style="margin-top: 20px; border-top: 1px solid rgb(213, 213, 213);"
    ...
    <table width="600" border="0" style="margin-top: 20px" align="center" cellpadding="0"cellspacing="0">
            <tr>
                <td colspan="3" style="background-color: #3B5998; font-weight: bold; color: White;
                    height: 25px; font-size: 14px">
                    ApnerDeal.com Email a friend service
                </td>
            </tr>
            <tr>
                <td colspan="2">
