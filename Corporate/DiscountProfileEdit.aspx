<%@ Page Language="C#" MasterPageFile="~/Corporate/MPCorporate2.master" AutoEventWireup="true" CodeFile="DiscountProfileEdit.aspx.cs" Inherits="Corporate_DiscountProfileEdit" Title="ApnerDeal.com" %>
...
<table width="100%" border="0px" cellspacing="0px" cellpadding="0px">
   ...
   <td align="right">
    ...
    <table border="0" cellpadding="8px" class="cptable" cellspacing="0" style="border-bottom: #efefe2 1px solid" width="100%">
    <tr>
    <td  align="left" colspan="2" style="height:37px; color:#365EBF; text-decoration:underline;">
    <strong><a target="_self" href="<%=CompanyInformationEditingPage%>">Edit Company Information</a></strong></td>
    <td>
    </td>
    </tr>
    <tr>
...
50 Taka off on your purchase of 1000 Taka </span>
    ...
    <td align="left" style="height:auto;">
        ...
        <cc1:calendarextender id="ceFromDate" runat="server" cssclass="cal_Theme1" Format="dd/MM/yyyy" popupposition="TopRight"
