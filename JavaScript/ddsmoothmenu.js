...
shadow: {enabled:false, offsetx:3, offsety:2},
...
getajaxmenu:function($, setting){ //function to fetch external page containing the panel DIVs
	...
	$.ajax({
		...
		success:function(content){
		    var sPos = content.indexOf('<div id="'+setting.mainmenuid+'">');
		    var ePos = content.lastIndexOf('</div>');
			$menucontainer.html(content.substring(sPos,ePos+6));
