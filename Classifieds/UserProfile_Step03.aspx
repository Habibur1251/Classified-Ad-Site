<%@ Page Language="C#" MasterPageFile="~/Classifieds/MPClassifieds1.master" AutoEventWireup="true" CodeFile="UserProfile_Step03.aspx.cs" Inherits="Classifieds_UserProfile_Step03" Title="www.apnerdeal.com – New User Registration." %>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <%if(this.intActionResult > 0){ %>
        ...
        <span class="pageTitle">Congratulation!</span> &nbsp; You have successfully register www.apnerdeal.com                                 
        <br />
    <%} %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cptable" style="border-top:1px solid #EFEFE2;">
        ...
        <%if(this.intActionResult > 0){ %>
             Click <strong><a href="Default.aspx">here</a> </strong> if this page not redirecting within 5 seconds.        
        <%} %>                  
        </td>
        </tr>            
        <tr>
