...
public partial class EmailAFriend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            strUrl = Server.UrlEncode(Request.QueryString["data"].ToString());
            //strUrl = Server.UrlDecode(strUrl);
            strUrl = "http://www.apnerdeal.com/ShowAllPrintableDiscount.aspx";
